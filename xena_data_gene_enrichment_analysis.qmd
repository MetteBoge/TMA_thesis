...
R_element_name_2 <- ifelse(c_type == "SKCM", 
                         paste0(file_path_xenadata, 'GSEA_Rdata/gsea_results_ssgsea', sub_ctype, '.RData'),
                          paste0(file_path_xenadata, 'GSEA_Rdata/gsea_results_ssgsea', c_type, '.RData'))
...
if (!file.exists(R_element_name_2)){
  ...
  full_corr_df <- full_corr_df %>% 
    mutate(gene = recode(gene, !!!geneName_ensg_nlist))
